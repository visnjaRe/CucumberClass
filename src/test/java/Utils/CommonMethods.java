...
public class CommonMethods extends PageInitializer {
    ...
    public static void openBrowserAndLaunchApplication() {
        ...
        //to configure the file and the pattern it has
        DOMConfigurator.configure("log4j.xml");
        Log.startTestCase("This is the begging of my Test Case");
    ...
    public static void closeBrowser() {
        Log.info("this is tx about to get completed");
        Log.endTestCase("TC is finished");
        driver.close();
    }
